...
*/
const XPTN = '🤖UW-BC🤖'; // Nama Bot Whatsapp
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] UW-BC Ready scan now!`);
});
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *🤖UW-BC🤖* , Follow Instagram Mimin Yah😻 : https://instagram.com/@Uwiw_Bocah' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *🤖UW-BC🤖* , Follow Instagram Mimin Yah😻 : https://instagram.com/@Uwiw_Bocah' ,MessageType.text);
}
